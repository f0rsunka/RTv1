...
void	init_sphere_0(t_object *sphere)
{
...
void	init_sphere_1(t_object *sphere)
{
...
void	init_sphere_2(t_object *sphere)
{
...
void	init_sphere_3(t_object *sphere)
{
...
void	init_sphere(int i, t_scene *scene)
{
	...
	scene->type = SPHERE;
	if (i == 0)
		init_sphere_0((t_object *)scene->object);
	if (i == 2)
		init_sphere_1((t_object *)scene->object);
	if (i == 3)
		init_sphere_2((t_object *)scene->object);
	// if (i == 3)
	// 	init_sphere_3((t_object *)scene->object);
}
