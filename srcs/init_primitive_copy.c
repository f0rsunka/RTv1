...
{
	sphere[0].material.color = transform_color(PINK);
	// sphere[0].center = (t_vec3){0.0, 0.0, 3.0};
	sphere[0].center = (t_vec3){0.0, -1.0, 3.0};
	sphere[0].radius = 1.0f;
	sphere[0].material.specular = transform_specular(800.0f);
	// sphere[0].material.specular = 500.0f;



	sphere[1].material.color = transform_color(BLUE);
	// sphere[1].center = (t_vec3){1.2, 0.0, 3.0};
	sphere[1].center = (t_vec3){-2.0, 1.0, 3.0};
	sphere[1].radius = 1.0f;
	// sphere[1].material.specular = 500.0f;
	sphere[1].material.specular = transform_specular(800.0f);



	sphere[2].material.color = transform_color(PURPLE);
	// sphere[2].center = (t_vec3){-1.2f, 0.0, 3.0};
	sphere[2].center = (t_vec3){2.0f, 1.0, 3.0};
	sphere[2].radius = 1.0f;
	// sphere[2].material.specular = 500.0f;
	sphere[2].material.specular = transform_specular(800.0f);
